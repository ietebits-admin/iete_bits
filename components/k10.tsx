...
const k10Members = [
  ...
  },
  {
    ...
    title: "Sumit Kumar",
    subtitle: "",
    linkedin: "linkedin.com",    borderColor: "#3B82F6",
    gradient: "",
  },
  {
    image: "",
...
export function NextGen10Section() {
  const { ref, isInView } = useInView({ threshold: 0.1 })

  const [scrambledText, setScrambledText] = useState("")
  const [hasAnimated, setHasAnimated] = useState(false)

  const finalText = "Alumni 2K10"
