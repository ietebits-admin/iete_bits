...
const k14Members = [
  {
    image: "/img11.jpg",
    title: "Niraj Kumar",
    subtitle: "NIT Jamshedpur",
    linkedin: "https://www.linkedin.com/in/niraj-kumar-28b774134",
    borderColor: "#3B82F6",
    gradient: "",
  },
  {
  ...
  {
    image: "/Sudhanshu.jpg",
    title: "Sudhanshu Ambastha",
    subtitle: "bloomreach.png",
    linkedin: "https://www.linkedin.com/in/sudhanshu-ambastha",
    borderColor: "#3B82F6",
    gradient: "",
  },
  {
    image: "/Arvind Marandi.png",
    title: "Arvind Marandi",
    subtitle: "IIT Kanpur",
    linkedin: "linkedin.com",
    borderColor: "#3B82F6",
    gradient: "",
  ...
  {
    image: "/Himanshu Harsh.jpg",
    title: "Himanshu Harsh",
    subtitle: "IIM Visakhapatnam",
    linkedin: "linkedin.com",
    borderColor: "#3B82F6",
    gradient: "",
  },
  {
    image: "/Navtosh Arun.jpg",
    title: "Navtosh Arun",
    subtitle: "Preparing for UPSC Exam",
    linkedin: "https://in.linkedin.com/in/navtosh-arun",
    borderColor: "#3B82F6",
    gradient: "",
  },
  {
    image: "/Parimal Roy.jpeg",
    title: "Parimal Roy",
    subtitle: "Rakuten",
    linkedin: "linkedin.com",
    borderColor: "#3B82F6",
  ...
  },
  {
    image: "/Kritee.jpeg",
    title: "Kritee Rani",
    subtitle: "Datta Meghe Institute of MSci.",
    linkedin: "linkedin.com",
    borderColor: "#3B82F6",
    gradient: "",
  },
  {
    image: "/Ashish Kumar Saw.jpeg",
    title: "Ashish Saw",
    subtitle: "Icici securities",
    linkedin: "https://www.linkedin.com/in/ashish-kumar-saw-ab2b9212a",
    borderColor: "#3B82F6",
    gradient: "",
  },
]

export function NextGen14Section() {
  const { ref, isInView } = useInView({ threshold: 0.1 })

  const [scrambledText, setScrambledText] = useState("")
  const [hasAnimated, setHasAnimated] = useState(false)

  const finalText = "Alumni 2K14"
